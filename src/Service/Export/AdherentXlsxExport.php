...
class AdherentXlsxExport extends AbstractXlsxExport
{
    ...
    protected function buildLine(Worksheet $worksheet, int $rowIndex, mixed $data): void
    {
        ...
        $worksheet->setCellValue(self::_CELL($columnIndex++, $rowIndex), $data->getAdherent()->getAddress());
        $worksheet->setCellValue(self::_CELL($columnIndex++, $rowIndex), $data->getComment());
