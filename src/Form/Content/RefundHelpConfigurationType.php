...
class RefundHelpConfigurationType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('passCitizenAmount', NumberType::class, ['required' => false])
            ...
            ->add('passSportAmount', NumberType::class, ['required' => false])
            ...
            ->add('ccasAmount', NumberType::class, ['required' => false])
